...
#SBATCH --mem=300G                   # bump if needed
...
SCRIPT="${WORKDIR}/run_xc.py"   # full path to the Python script
XENIUM_ROOT="/projects/chuang-lab/thiesa/human_lung_xenium"       # directory containing run subfolders
...
module load singularity || true   # ignore if not needed / using apptainer

...
def main(random_seed):
    ...
    for fold, (train_index, test_index) in enumerate(
        ...
        stats_filename = f"weights_bias_stats_mil3_fold{fold+1}.txt"
        ...
        plt.ylabel("Density")
        plt.savefig(f"mil3_embedding_weights_distribution_fold_{fold+1}.png")
        # plt.show()
        ...
        accuracy, auroc, precision, recall = evaluate(
            ...
            output_file=f"mil3_metrics_output_fold{fold+1}.txt"
        )
    ...
    plt.ylabel("Loss")
    plt.legend()
    plt.savefig("training_loss_mil3.png")
    # plt.show()
    ...
    with open("mil2_cross_validation_metrics.txt", "w") as f:

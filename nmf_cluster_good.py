...
selected_proteins = ['Ki67', 'aSMA', 'CD11c', 'Vimentin', 'CD45', 'CD3', 'CD31', 'p21', 'CD4', 'CD19']
# Example: If these proteins correspond to specific channel indices in your data, you can map them here
channel_indices = [1, 2, 6, 7, 8, 9, 11, 15, 18, 20]  # Replace with correct indices for selected proteins

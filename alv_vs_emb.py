...
def run_crossval_and_plot_roc(filtered_df, 
    ...
    plt.title("Alveolar vs. Embryonal", fontsize=24)
    ...
    roc_path = os.path.join(output_dir, "alveolar_embryonal_new_best_combo_mean_roc.pdf")
    ...
    for thres in thresholds:
        ...
        cm_path = os.path.join(output_dir, f"ae_confmat_threshold_{thres}.pdf")
    ...
    prf1_path = os.path.join(output_dir, "ae_precision_recall_f1_curve.pdf")

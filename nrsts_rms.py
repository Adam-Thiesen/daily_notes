...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    plt.title("NRSTS vs. RMS", fontsize=24)
    ...
    roc_path = os.path.join(output_dir, "rms_nrsts_best_combo_mean_roc.pdf")
    ...
    for thres in thresholds:
        ...
        ax.set_yticks([0, 1])  
        ax.set_yticklabels(["RMS", "NRSTS"], rotation=90, va='center')
        ax.set_ylabel("True label", rotation=90, labelpad=15)
        ax.set_xlabel("Predicted label")
        ax.set_title(f"Confusion Matrix at threshold={thres}")

        cm_path = os.path.join(output_dir, f"rms_nrsts_confmat_threshold_{thres}.pdf")
    ...
    prf1_path = os.path.join(output_dir, "rms_nrsts_precision_recall_f1_curve.pdf")
